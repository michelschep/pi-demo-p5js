...
De pagina SHALL een `<h1>` element bevatten met de tekst "Stuiteren!" dat bovenaan de pagina wordt weergegeven in de kleur rood en het lettertype Comic Sans MS.
